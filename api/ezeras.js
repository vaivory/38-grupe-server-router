...
handler.ezeras = async (data, callback) => {
...
handler._innerMethods.put = async (data, callback) => {
    ...
    return callback(200, {
        msg: 'Ezeras informacija sekmingai atnaujinta',
    });
}
...
handler._innerMethods.delete = async (data, callback) => {
    ...
    return callback(200, {
        msg: 'Ezeras istrintas sekmingai',
    });
}
