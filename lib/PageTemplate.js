...
// // 1)
// if (isLoggedIn) {
//     HTML += `<script src="/js/components/commonPrivate.js" type="module" defer></script>`;
// } else {
//     HTML += `<script src="/js/components/commonPublic.js" type="module" defer></script>`;
// }

// // 2)
// HTML += isLoggedIn
//     ? `<script src="/js/components/commonPrivate.js" type="module" defer></script>`
//     : `<script src="/js/components/commonPublic.js" type="module" defer></script>`;

// // 3)
// HTML += `<script src="/js/components/common${isLoggedIn ? 'Private' : 'Public'}.js" type="module" defer></script>`;

//arba dar galima taip uzrasyti ta pati dalyka:
        HTML += isLoggedIn
